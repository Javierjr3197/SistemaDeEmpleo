...
import Logical.EmpresaSolicitadora;
import Logical.Obrero;
import Logical.SolicitudesObrero;
import Logical.SolicitudesTecnico;
import Logical.SolicitudesUni;
...
public class RegistrarPlaza extends JDialog {
	...
	public RegistrarPlaza() {
		...
		panel_4.setBorder(new TitledBorder(null, "Educacion", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		panel_4.setBounds(300, 164, 345, 154);
		...
		lblIngreseRnc.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblIngreseRnc.setBounds(10, 14, 191, 28);
	...
	protected void clean() {
		...
		cbxIdioma2.setModel(new DefaultComboBoxModel(new String[] {"<Seleccionar>", "Ingles", "Espa\u00F1ol", "Frances", "Aleman", "Mandarin", "Italiano", "Japones", "Creoles", "Ruso"}));
		cbxIdioma3.setModel(new DefaultComboBoxModel(new String[] {"<Seleccionar>", "Ingles", "Espa\u00F1ol", "Frances", "Aleman", "Mandarin", "Italiano", "Japones", "Creoles", "Ruso"}));
		cbxCarreraUni.setSelectedIndex(0);
